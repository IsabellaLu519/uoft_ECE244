...
// Parses the command to create a rectangle
Shape* parseRectangleCommand(stringstream& line)
{
    string name;
    ...
    Shape *myShapeR = (Shape *)new Rectangle(name, xcent, ycent, width, height);
    cout << "created rectangle" << endl;
    return myShapeR;
}

// Parses the command to create a triangle
Shape* parseTriangleCommand(stringstream& line)
{
    string name;
    ...
    Shape *myShapeT = (Shape *)new Triangle(name, x1, y1, x2, y2, x3, y3);
